...
if [ $stage -le 0 ]; then
  ...
  local/200hourdata_untar.sh $dbase/200hourdata 200hourdata || exit 1;
  ...
  local/200hourdata_untar.sh $dbase/200hourdata dev_set || exit 1;
...
if [ $stage -le 1 ]; then
  ...
  local/200hour_data_prep.sh $dbase/200hourdata data/200hour || exit 1;
fi
